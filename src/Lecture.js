    ...
    return (
        <>
            <section class="Body">
                ...
                <section>
                    <section class="lecture-streams" id="after-10th">
                        ...
                        <div class="card-container">
                            ...
                            <div class="card">
                                ...
                                <a href="https://en.wikipedia.org/wiki/Medical_education_in_India" target="_blank">Watch Lectures on
                                    YouTube</a>
                            </div>
                            <div class="card">
                                <h3>💼 Commerce</h3>
                            ...
                            <div class="card">
                                ...
                                <a href="https://en.wikipedia.org/wiki/Industrial_training_institute" target="_blank">Watch Lectures on
                                    YouTube</a>
                            </div>
                            <div class="card">
                                <h3>🏗️ Polytechnic</h3>
                    ...
                    <section class="lecture-streams" id="after-12th">
                        ...
                        <div class="card-container">
                            ...
                            <div class="card">
                                ...
                                <a href="https://en.wikipedia.org/wiki/Bachelor_of_Medicine,_Bachelor_of_Surgery" target="_blank">Watch
                                    Lectures on YouTube</a>
                            </div>
                            <div class="card">
                            ...
                            <div class="card">
                                ...
                                <a href="https://en.wikipedia.org/wiki/List_of_central_civil_services_examinations_in_India"
                                    target="_blank">Watch Lectures on YouTube</a>
                            </div>
                        </div>
                    </section>
                    <section class="lecture-streams" id="after-graduation">
                        ...
                        <div class="card-container">
                            ...
                            <div class="card">
                                ...
                                <a href="https://en.wikipedia.org/wiki/Master_of_Business_Administration" target="_blank">Watch Lectures on
                                    YouTube</a>
                            </div>
                            <div class="card">
                                <h3>💻 MCA</h3>
                                <p>Master of Computer Applications for careers in software development and IT management.</p>
                                <a href="https://en.wikipedia.org/wiki/Master_of_Computer_Applications" target="_blank">Watch Lectures on
                                    YouTube</a>
                            </div>
                            <div class="card">
                                <h3>🏛️ UPSC / Civil Services</h3>
                                <p>India’s top administrative exams for roles like IAS, IPS, and IFS.</p>
                                <a href="https://en.wikipedia.org/wiki/Civil_Services_Examination_(India)" target="_blank">Watch Lectures on
                                    YouTube</a>
                            </div>
                            <div class="card">
                                <h3>🏦 Banking Exams</h3>
                                <p>Includes IBPS, SBI PO, and RBI exams for careers in public sector banks.</p>
                                <a href="https://en.wikipedia.org/wiki/Institute_of_Banking_Personnel_Selection" target="_blank">Watch
                                    Lectures on YouTube</a>
                            </div>
                            <div class="card">
                                <h3>📐 GATE</h3>
                                <p>Graduate Aptitude Test in Engineering for M.Tech admissions and PSU jobs.</p>
                                <a href="https://en.wikipedia.org/wiki/Graduate_Aptitude_Test_in_Engineering" target="_blank">Watch Lectures
                                    on YouTube</a>
                            </div>
                            <div class="card">
                                <h3>📚 NET / SET</h3>
                                <p>Eligibility tests for lectureship and research fellowships in Indian universities.</p>
                                <a href="https://en.wikipedia.org/wiki/National_Eligibility_Test" target="_blank">Watch Lectures on
                                    YouTube</a>
                            </div>
                            <div class="card">
                                <h3>🌍 Foreign Studies (GRE / IELTS / TOEFL)</h3>
                                <p>Entrance exams for studying abroad in the US, UK, Canada, and other countries.</p>
                                <a href="https://en.wikipedia.org/wiki/Graduate_Record_Examinations" target="_blank">Watch Lectures on
                                    YouTube</a>
                            </div>
                            <div class="card">

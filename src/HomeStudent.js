  ...
  return (
    <>
      ...
      <section className="home-student-container">
        ...
        <section className="home-student-content">
          <section className="home-student-paths">
            <h2>Choose Your Path</h2>
            <div className="home-student-card-group">
          ...
          <h2 className="home-student-subheading">Explore Learning Resources</h2>
          <p className="home-student-desc">Discover lectures, fields of education, industry experience, and personalize your profile.</p>
        </section>
      </section>
    </>
  );
